# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-07-22 09:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motif', models.CharField(max_length=14, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nanarino.Album')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nanarino.Article')),
                ('writer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('time',),
